...
1. Read `/Users/wasabi/Repository/JobSearchAgent-3/context/searchTerms.md`. Collect every non-empty line as a search term.
...
You are a job-listing fetcher working in `/Users/wasabi/Repository/JobSearchAgent-3/`.
...
- Query: `"select:mcp__claude_ai_Dice_Job_Search__search_jobs"`
...
- **Dice:** `mcp__claude_ai_Dice_Job_Search__search_jobs`
...
If a file with that name already exists in `/Users/wasabi/Repository/JobSearchAgent-3/jobListings-Raw/`, skip it.

#### F — Write the file

Save to `/Users/wasabi/Repository/JobSearchAgent-3/jobListings-Raw/<filename>` with this exact structure:
